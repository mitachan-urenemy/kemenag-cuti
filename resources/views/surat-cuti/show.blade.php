        ...
        >
            <x-slot name="action">
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('surat-cuti.download', ['surat' => $surat]) }}" class="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold text-white uppercase transition-colors duration-200 bg-indigo-600 border border-transparent rounded-lg hover:bg-indigo-700">
