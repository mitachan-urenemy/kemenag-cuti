    ...
    <div class="container">
        ...
        <div class="content">
            <div class="nomor-surat" style="margin-top: 40px;">
                <strong>IZIN PELAKSANAAN CUTI SAKIT</strong><br>
                <strong>Nomor : {{ $nomor_surat ?? '-' }}</strong>
            </div>

            <div class="body-text">
                1. Diberikan izin untuk melaksanakan cuti sakit kepada Pegawai Negeri Sipil :
            </div>
            ...
            <div class="ketentuan">
                ...
                <div class="ketentuan-list">
                    <div class="ketentuan-item">
                        ...
                        <span class="text">Selama menjalankan cuti sakit, bersedia menjalankan tugas yang sewaktu waktu diberikan oleh atasan.</span>
                    </div>
                    <div class="ketentuan-item">
            ...
            <div class="penutup">
                2. Demikian izin pelaksanaan cuti sakit ini dibuat, untuk dapat digunakan sebagaimana mestinya.
            </div>
