...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"
        integrity="sha512-NhfZj0MXBZYr1Py6kS3OXLtjQwXDGNANTZj3QN8cOWdDdknSv3zJX2DuPhE0AIh2k1/y5+ekUNhhkOdQVnDQ=="
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-sm text-gray-500 mt-0.5">
                                Assalamualaikum,
                                <span
                                    class="font-medium text-gray-700">{{ ucfirst(Auth::user()->username) ?? 'Admin' }}</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        <button @click="dropdownOpen = !dropdownOpen"
                            ...
                            <div class="hidden md:block text-left">
                                <p
                                    class="text-sm font-semibold text-gray-700 group-hover:text-green-primary transition-colors">
